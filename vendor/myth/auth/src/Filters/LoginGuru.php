...
class LoginGuru implements FilterInterface
{
	/**
	...
	public function before(RequestInterface $request, $params = null)
	{
		...
		if (in_array((string)$current, [route_to('loginGuru'), route_to('forgot'), route_to('reset-password'), route_to('register'), route_to('activate-account')]))
		{
			return;
		}
