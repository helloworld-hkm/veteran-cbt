...
class AuthController extends Controller
{
	...
	public function loginAdmin()
	{
		...
		return $this->_render($this->config->views['loginAdmin'], ['config' => $this->config]);
	}
	...
	public function loginGuru()
	{
		...
		return $this->_render($this->config->views['loginGuru'], ['config' => $this->config]);
	}
	 ...
	 * through a POST request.
	 */
	public function attemptloginGuru()
	{
		$rules = [
			'login'	=> 'required',
			'password' => 'required',
